...
; we put some other boot2 util here cos why not

find_segment_offset:
    ; Input: EAX = physical_address
    ; Output: BX = segment, DX = offset

    ; Calculate the segment.
    mov     cx, 16              ; CX = 16
    xor     dx, dx              ; Clear DX (offset)
    div     cx                  ; Divide EAX by CX (16), quotient in AX, remainder in DX
    mov     bx, ax              ; Copy quotient (segment) to BX

    ; Output segment in BX, output offset in DX
    ret
